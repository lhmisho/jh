...
export default class ProfessionalAssociationSelect extends Component {
    ...
    loadOptions(inputValue, callback) {
        axios.get('/api/v2/professional_associations/', {
            params: {
                search: inputValue
            }
        }).then(resp => {
    ...
    buildADefaultValue(id) {
        axios.get('/api/v2/professional_associations/' + id + '/').then(resp => {
